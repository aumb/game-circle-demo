...
class ReviewImagePreview extends StatefulWidget {
  ...
  @override
  _ReviewImagePreviewState createState() => _ReviewImagePreviewState();
}

class _ReviewImagePreviewState extends State<ReviewImagePreview> {
