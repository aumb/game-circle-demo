...
class GetMoreFavoriteLounges implements UseCase<List<Lounge?>, NoParams> {
  final FavoritesRepository repository;

  GetMoreFavoriteLounges(this.repository);

  @override
  Future<Either<Failure, List<Lounge?>>> call(NoParams params) async {
    return await repository.getMoreFavoriteLounges();
  }
}
