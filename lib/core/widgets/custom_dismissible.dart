...
/// non-null, the CustomDismissible widget animates its height (or width, whichever is
...
/// is specified it is stacked behind the CustomDismissible's child and is exposed when
/// the child moves.
///
/// The widget calls the [onDismissed] callback either after its size has
/// collapsed to zero (if [resizeDuration] is non-null) or immediately after
/// the slide animation (if [resizeDuration] is null). If the CustomDismissible is a
...
class CustomDismissible extends StatefulWidget {
  ...
  /// CustomDismissible will begin upon the detection of a drag gesture. If set to
  ...
  Widget build(BuildContext context) {
      ...
      assert(() {
        if (_resizeAnimation!.status != AnimationStatus.forward) {
          ...
          throw FlutterError.fromParts(<DiagnosticsNode>[
            ErrorSummary(
                'A dismissed CustomDismissible widget is still part of the tree.'),
            ErrorHint(
    ...
    return GestureDetector(
      onHorizontalDragStart:
          widget.disable ? null : (_directionIsXAxis ? _handleDragStart : null),
      onHorizontalDragUpdate: widget.disable
          ? null
          : (_directionIsXAxis ? _handleDragUpdate : null),
      onHorizontalDragEnd:
          widget.disable ? null : (_directionIsXAxis ? _handleDragEnd : null),
      onVerticalDragStart:
          widget.disable ? null : (_directionIsXAxis ? null : _handleDragStart),
      onVerticalDragUpdate: widget.disable
          ? null
          : (_directionIsXAxis ? null : _handleDragUpdate),
      onVerticalDragEnd:
          widget.disable ? null : (_directionIsXAxis ? null : _handleDragEnd),
