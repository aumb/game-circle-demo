...
void main() {
  ...
  test(
    ...
    () async {
      // arrange
      when(
        () => mockReviewsRepository.getUserReviews(
      ...
      verify(() => mockReviewsRepository.getUserReviews(
            sortBy: "",
          ));
